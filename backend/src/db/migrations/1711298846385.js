module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('suppliers', 'contact_email', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('suppliers', 'company_name', {
        transaction,
      });

      await queryInterface.removeColumn('purchase_orders', 'supplierId', {
        transaction,
      });

      await queryInterface.removeColumn('purchase_orders', 'status', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('products', 'stock_level', {
        transaction,
      });
